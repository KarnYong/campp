    ...
    PackagesConfig {
        php: vec![
            PhpPackage {
                ...
                display_name: "PHP 8.5 (Latest)".to_string(),
                windows_x64: "https://windows.php.net/downloads/releases/php-8.5.1-Win32-vs17-x64.zip".to_string(),
                windows_arm64: "https://windows.php.net/downloads/releases/php-8.5.1-Win32-vs17-x86.zip".to_string(),
                linux_x64: "https://dl.static-php.dev/static-php-cli/bulk/php-8.5.1-fpm-linux-x86_64.tar.gz".to_string(),
                linux_arm64: "https://dl.static-php.dev/static-php-cli/bulk/php-8.5.1-fpm-linux-aarch64.tar.gz".to_string(),
                macos_x64: "https://dl.static-php.dev/static-php-cli/bulk/php-8.5.1-fpm-macos-x86_64.tar.gz".to_string(),
                macos_arm64: "https://dl.static-php.dev/static-php-cli/bulk/php-8.5.1-fpm-macos-aarch64.tar.gz".to_string(),
                eol: false,
                lts: false,
                recommended: true,
            },
            PhpPackage {
                ...
                windows_arm64: "https://windows.php.net/downloads/releases/php-8.4.16-Win32-vs17-x86.zip".to_string(),
            ...
            PhpPackage {
                ...
                display_name: "PHP 8.3".to_string(),
                windows_x64: "https://windows.php.net/downloads/releases/php-8.3.29-Win32-vs16-x64.zip".to_string(),
                windows_arm64: "https://windows.php.net/downloads/releases/php-8.3.29-Win32-vs16-x86.zip".to_string(),
                linux_x64: "https://dl.static-php.dev/static-php-cli/bulk/php-8.3.29-fpm-linux-x86_64.tar.gz".to_string(),
                linux_arm64: "https://dl.static-php.dev/static-php-cli/bulk/php-8.3.29-fpm-linux-aarch64.tar.gz".to_string(),
                macos_x64: "https://dl.static-php.dev/static-php-cli/bulk/php-8.3.29-fpm-macos-x86_64.tar.gz".to_string(),
                macos_arm64: "https://dl.static-php.dev/static-php-cli/bulk/php-8.3.29-fpm-macos-aarch64.tar.gz".to_string(),
                eol: false,
                lts: false,
                recommended: false,
            },
            PhpPackage {
                ...
                display_name: "PHP 8.2 (Security)".to_string(),
                windows_x64: "https://windows.php.net/downloads/releases/php-8.2.30-Win32-vs16-x64.zip".to_string(),
                windows_arm64: "https://windows.php.net/downloads/releases/php-8.2.30-Win32-vs16-x86.zip".to_string(),
        ...
        phpmyadmin: vec![
            PhpMyAdminPackage {
                ...
                display_name: "phpMyAdmin 5.2 (Latest)".to_string(),
